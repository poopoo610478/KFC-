<template>
  <div>
    <!-- 篩選按鈕 -->
    <button @click="toggleFriedChickenFilter" class="filter-btn">炸雞</button><!-- 重點1 -->
    <button @click="toggleFriesFilter"class="filter-btn">薯條</button><!-- 新增薯條按鈕 -->
    <button @click="toggleEggTartFilter"class="filter-btn">蛋撻</button>
    <button @click="toggleHamburgerFilter"class="filter-btn">漢堡</button>
    <button @click="toggleChickenNuggetsFilter"class="filter-btn">雞塊</button>
    <button @click="toggleDrinksFilter"class="filter-btn">飲料</button>
    <button @click="toggleQQBallFilter"class="filter-btn">QQ球</button>
    <button @click="toggleChikenRiceFilter"class="filter-btn">雞汁飯</button>
    <button @click="toggleHerbChikenFilter"class="filter-btn">紙包雞</button>
    <button @click="toggleMexicoChikenFilter"class="filter-btn">雞腿捲</button>
    <button @click="toggleFishDonutFilter"class="filter-btn">鱈魚圈</button> 
    <button @click="toggleShrimpNuggetFilter"class="filter-btn">超蝦塊</button>
<br>
    <!-- 第二排篩選按鈕 -->
   <button @click="toggleNoFriedChickenFilter" class="exclude-btn">不要炸雞</button>
   <button @click="toggleNoFriesFilter" class="exclude-btn">不要薯條</button>
   <button @click="toggleNoEggTartFilter" class="exclude-btn">不要蛋撻</button>
   <button @click="toggleNoHamburgerFilter" class="exclude-btn">不要漢堡</button>
   <button @click="toggleNoChickenNuggetsFilter" class="exclude-btn">不要雞塊</button>
   <button @click="toggleNoDrinksFilter" class="exclude-btn">不要飲料</button>
   <button @click="toggleNoQQBallFilter" class="exclude-btn">不要QQ球</button>
   <button @click="toggleNoChikenRiceFilter" class="exclude-btn">不要雞汁飯</button>
   <button @click="toggleNoHerbChikenFilter" class="exclude-btn">不要紙包雞</button>
   <button @click="toggleNoMexicoChikenFilter" class="exclude-btn">不要雞腿捲</button>
   <button @click="toggleNoFishDonutFilter" class="exclude-btn">不要鱈魚圈</button>
   <button @click="toggleNoShrimpNuggetFilter" class="exclude-btn">不要超蝦塊</button>
...
export default {
  ...
  setup() {
    ...
    const toggleNoChickenNuggetsFilter = () => {
      showOnlyChickenNuggets.value = !showOnlyChickenNuggets.value;
      updateFilteredImages();
    };
    ...
    const toggleNoQQBallFilter = () => {
      showOnlyNoQQBall.value = !showOnlyQQBall.value;
      updateFilteredImages();
    };
